...
pub unsafe extern "C" fn wgpuAdapterRequestDevice(
    ...
    match err {
        ...
        Some(err) => {
            check_determinism_issue(
                RuntimeErrors::RequestDeviceError(err.clone()),
                "wgpuAdapterRequestDevice",
            );
...
pub unsafe extern "C" fn wgpuBufferMapAsync(
    ...
    if let Err(cause) = gfx_select!(buffer_id => context.core.buffer_map_async(
        ...
        handle_error(
            error_sink,
            RuntimeErrors::BufferAccessError(cause),
            None,
            "wgpuBufferMapAsync",
        );
    };
...
pub unsafe extern "C" fn wgpuCommandEncoderBeginComputePass(
    ...
    if let Some(cause) = err {
        handle_error(
            error_sink,
            RuntimeErrors::CommandEncoderError(cause),
            desc.label,
...
pub unsafe extern "C" fn wgpuCommandEncoderClearBuffer(
    ...
    if let Err(cause) = gfx_select!(command_encoder_id => context.core.command_encoder_clear_buffer(
        ...
        handle_error(
            error_sink,
            RuntimeErrors::ClearError(cause),
            None,
...
pub unsafe extern "C" fn wgpuCommandEncoderResolveQuerySet(
    ...
    if let Err(cause) = gfx_select!(command_encoder_id => context.core.command_encoder_resolve_query_set(
        ...
        handle_error(
            error_sink,
            RuntimeErrors::QueryError(cause),
            None,
...
pub unsafe extern "C" fn wgpuComputePassEncoderDispatchWorkgroups(
    ...
    match encoder.dispatch_workgroups(
        ...
        Err(cause) => handle_error(
            &pass.error_sink,
            RuntimeErrors::ComputePassError(cause),
            None,
...
pub unsafe extern "C" fn wgpuComputePipelineGetBindGroupLayout(
    ...
    if let Some(cause) = error {
        handle_error(
            error_sink,
            RuntimeErrors::GetBindGroupLayoutError(cause),
            None,
...
pub unsafe extern "C" fn wgpuDeviceCreateBindGroup(
    ...
    if let Some(cause) = error {
        handle_error(
            error_sink,
            RuntimeErrors::CreateBindGroupError(cause),
            desc.label,
...
pub unsafe extern "C" fn wgpuDeviceCreateBindGroupLayout(
    ...
    if let Some(cause) = error {
        handle_error(
            error_sink,
            RuntimeErrors::CreateBindGroupLayoutError(cause),
            desc.label,
...
pub unsafe extern "C" fn wgpuDeviceCreateBuffer(
    ...
    if let Some(cause) = error {
        handle_error(
            error_sink,
            RuntimeErrors::CreateBufferError(cause),
            desc.label,
...
pub unsafe extern "C" fn wgpuDeviceCreateCommandEncoder(
    ...
    if let Some(cause) = error {
        handle_error(
            error_sink,
            RuntimeErrors::DeviceError(cause),
            desc.label,
...
pub unsafe extern "C" fn wgpuDeviceCreateComputePipeline(
    ...
    if let Some(cause) = error {
        ...
        handle_error(
            error_sink,
            RuntimeErrors::CreateComputePipelineError(cause),
            desc.label,
...
pub unsafe extern "C" fn wgpuDeviceCreatePipelineLayout(
    ...
    if let Some(cause) = error {
        handle_error(
            error_sink,
            RuntimeErrors::CreatePipelineLayoutError(cause),
            desc.label,
...
pub unsafe extern "C" fn wgpuDeviceCreateQuerySet(
    ...
    if let Some(cause) = error {
        handle_error(
            error_sink,
            RuntimeErrors::CreateQuerySetError(cause),
            desc.label,
...
pub unsafe extern "C" fn wgpuDeviceCreateRenderPipeline(
    ...
    if let Some(cause) = error {
        ...
        handle_error(
            error_sink,
            RuntimeErrors::CreateRenderPipelineError(cause),
            desc.label,
...
pub unsafe extern "C" fn wgpuDeviceCreateSampler(
    ...
    if let Some(cause) = error {
        handle_error(
            error_sink,
            RuntimeErrors::CreateSamplerError(cause),
            desc.label,
...
pub unsafe extern "C" fn wgpuDeviceCreateShaderModule(
    ...
    let source = match follow_chain!(
        ...
        Err(cause) => {
            handle_error(
                error_sink,
                RuntimeErrors::ShaderParseError(cause),
                desc.label,
    ...
    if let Some(cause) = error {
        handle_error(
            error_sink,
            RuntimeErrors::CreateShaderModuleError(cause),
            desc.label,
            "wgpuDeviceCreateShaderModule",
        );
    }
...
pub unsafe extern "C" fn wgpuDeviceCreateTexture(
    ...
    if let Some(cause) = error {
        handle_error(
            error_sink,
            RuntimeErrors::CreateTextureError(cause),
            desc.label,
...
pub unsafe extern "C" fn wgpuQueueWriteBuffer(
    ...
    if let Err(cause) = gfx_select!(queue_id => context.core.queue_write_buffer(
        ...
        handle_error(
            error_sink,
            RuntimeErrors::QueueWriteError(cause),
            None,
...
pub unsafe extern "C" fn wgpuRenderPassEncoderBeginOcclusionQuery(
    ...
    match encoder.begin_occlusion_query(&pass.context.core, query_index) {
        ...
        Err(cause) => handle_error(
            &pass.error_sink,
            RuntimeErrors::RenderPassError(cause),
            None,
...
pub unsafe extern "C" fn wgpuTextureCreateView(
    ...
    if let Some(cause) = error {
        handle_error(
            error_sink,
            RuntimeErrors::CreateTextureViewError(cause),
            None,
